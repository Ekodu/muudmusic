...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "neonSUP")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "EkoBlogs") 
OWNER_NAME = getenv("OWNER_NAME", "Nevrozdu")
ALIVE_NAME = getenv("ALIVE_NAME", "Eko Music")
